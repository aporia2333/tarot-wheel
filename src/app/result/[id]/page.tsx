...
export default function ResultPage() {
  ...
  const content = loading ? <main className="page-shell"><div className="content-wrap text-center text-mist/70">正在读取结果…</div></main> : !reading ? (
    ...
    <main className="page-shell"><div className="content-wrap">
      ...
      {reading.question ? <section className="mx-auto mt-6 max-w-3xl text-center"><p className="text-sm text-mist/60">你的问题</p><p className="mt-2 text-lg leading-7 text-mist">{reading.question}</p></section> : null}
